...
const DashboardCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        const result = await client.service("dashboard").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info dashboard updated successfully" });
    ...
    return (
        <Dialog header="Edit Dashboard" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="dashboard-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(DashboardCreateDialogComponent);
